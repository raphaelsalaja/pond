...
/**
 * Captured response wrapper as the preload pushes it.
 */
 ...
 * `?name=orig` trick the DOM walker in
 * [`twitter-bookmarks.ts`](apps/desktop/src/main/core/refresh/harvest/twitter-bookmarks.ts)
 * uses for its cover images.
 */
