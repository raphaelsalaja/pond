...
/**
 * Developer surface — debugging + maintenance only. Production
 * integration points (URL scheme, Raycast, Shortcuts, local HTTP API,
 * CORS) live on the Automation page next door so this page stays
 * narrow: diagnostics, cache resets, danger zone.
 */
