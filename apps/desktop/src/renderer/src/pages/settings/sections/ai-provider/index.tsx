          ...
          <Settings.Item>
            <Settings.ItemDetails>
              ...
              <Settings.ItemDescription>
                Where Pond runs enrichment models.
              </Settings.ItemDescription>
            </Settings.ItemDetails>
                ...
                <Settings.ItemDetails>
                  ...
                  <Settings.ItemDescription>
                    {ollama === null
                      ? "Checking…"
                      : ollama.ok
                        ? `Reachable. ${ollama.modelCount ?? "?"}\u00A0models loaded.`
          ...
          <Settings.List>
            <Settings.Item>
              <Settings.ItemDetails>
                ...
                <Settings.ItemDescription>
                  Caption, alt text, tags, classification, and OCR.
                </Settings.ItemDescription>
              </Settings.ItemDetails>
              <Settings.ItemControl>
                <Input
            ...
            {isCloud ? (
              <Settings.Item>
                <Settings.ItemDetails>
                  ...
                  <Settings.ItemDescription>
                    Pause cloud providers above this daily spend.
                  </Settings.ItemDescription>
                </Settings.ItemDetails>
                <Settings.ItemControl>
                  <Input
