...
/**
 * Automation — the "wire Pond into your other tools" page. Local
 * HTTP server, ingest token, CORS allow-list, the `pond://` URL
 * scheme, plus Raycast and Apple Shortcuts snippets.
 *
 * Sits separately from Developer because none of these are debugging
 * surfaces — they're production integration points. Developer keeps
 * the diagnostics + reset surface.
 */
